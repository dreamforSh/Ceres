...
public class NetworkOptimizer {
    ...
    public static void init() {
        Neptune.LOGGER.info("Initializing NetworkOptimizer");
    }
    ...
    public static <T> int registerPacketProcessor(
        ...
        Neptune.LOGGER.debug("Registered packet processor for {} with ID {}", packetClass.getSimpleName(), packetId);
    ...
    public static void sendToServer(Object packet, int packetId) {
        ...
        if (processor == null) {
            Neptune.LOGGER.error("No packet processor registered for ID {}", packetId);
            return;
        }
        ...
        Neptune.NETWORK.sendToServer(compressedPacket);
    }
