...
@Mod.EventBusSubscriber(modid = Neptune.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class NeptuneConfig {
    ...
    public static void init() {
        ...
        Neptune.LOGGER.info("Neptune config initialized");
    }

    @SubscribeEvent
    public static void onClientConfigLoad(final ModConfigEvent.Loading event) {
        if (event.getConfig().getType() == ModConfig.Type.CLIENT) {
            Neptune.LOGGER.debug("Loaded Neptune client config");
        }
    }
    ...
    public static void onServerConfigLoad(final ModConfigEvent.Loading event) {
        if (event.getConfig().getType() == ModConfig.Type.SERVER) {
            Neptune.LOGGER.debug("Loaded Neptune server config");
        }
    }

    @SubscribeEvent
    public static void onConfigReload(final ModConfigEvent.Reloading event) {
        Neptune.LOGGER.debug("Neptune config reloaded");
    }
